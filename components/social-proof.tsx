...
function Img({ src, alt, dark }: { src: string; alt: string; dark?: boolean }) {
  return (
    <div
...
function CtaBtn({ label, dark }: { label: string; dark?: boolean }) {
  return (
    ...
    <section className="relative overflow-hidden py-20 sm:py-24 lg:py-28" style={{ background: 'var(--pale)' }}>
      ...
      <div className="max-w-[1080px] mx-auto px-5 sm:px-8 relative">
        ...
        <div className="sm:[column-count:2] lg:[column-count:3]" style={{ columnGap: 14 }}>
          {imgs.slice(0, 6).map((img, i) => <Img key={i} src={img.src} alt={img.alt} />)}
        </div>
  ...
  return (
    <section className="relative overflow-hidden py-20 sm:py-24 lg:py-28" style={{ background: 'var(--gd)' }}>
      ...
      <div className="max-w-[1080px] mx-auto px-5 sm:px-8 relative">
        ...
        <div className="sm:[column-count:2] lg:[column-count:3]" style={{ columnGap: 14 }}>
          {imgs.slice(3).map((img, i) => <Img key={i} src={img.src} alt={img.alt} dark />)}
        </div>
        <CtaBtn label="Quero fazer parte da Comunidade" dark />
      </div>
    </section>
  )
}
